...
date = 2023-02-28
description = "Defining power and torque as they apply to a vehicle system, and why the usual quote about hitting a wall explains neither."
...
source_url = "https://www.mechanicalsuperiority.com/power-vs-torque/"
+++
...
![Kirk Lazarus demanding that you suck his unit](images/01wtqywh.jpg)
...
First off, an elementary definition of torque is in order. Torque is simply a force applied at a certain distance (sometimes called the “moment arm”) from the center of rotation. The equation for torque ($\tau$) is:
...
$ F = \frac{\tau}{r} = \frac{1 lb-ft}{0.25 ft} = 4 lb $
...
$ P = \frac{\tau\_\text{eng} \cdot \omega\_\text{eng}}{5,252} $

Where P is the calculated Power (horsepower), $\tau$ is Torque (lb-ft), and $\omega$ is the Engine rotational speed (rev/min).
...
*If you found this post to be useful, or you want to send me love mail or hate mail, please feel free to provide feedback to mechanicalsuperiority@gmail.com*
